...
public class Calcular_fragment extends javax.swing.JInternalFrame{
    ...
    public void build() {
    	...
    	resultadoField.setBackground(new Color(235, 235, 235));
        ...
        LineBorder lineBorder = new LineBorder(new Color(0, 90, 158), 1, true);
    ...
    private void buttonNumbersStyle(JButton button) {
    	...
    	LineBorder lineBorder = new LineBorder(new Color(233, 235, 235), 1, true);
    ...
    private void buttonOperationsStyle(JButton button) {
    	...
    	LineBorder lineBorder = new LineBorder(new Color(240, 240, 240), 1, true);
        button.setBorder(lineBorder);
    }
